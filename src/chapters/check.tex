...
Damit das Plugin funktioniert, muss Redmine gar nicht angepasst werden, wie in der CI sichtbar. Das Plugin
wird einfach installiert und funktioniert. Auch die Brücken zu Redmine sind sehr klein. Das einzige was von
Redmine genutzt wird, ist das Issue Objekt. Dieses wird aber nur gelesen und nicht verändert.
