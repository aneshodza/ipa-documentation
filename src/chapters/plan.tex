...
\begin{minipage}{\textwidth}
  \subsubsection{Abfrage der Tickets}
  Wenn der Nutzer Tickets abfragt, kann er entweder die Übersicht oder die Details eines Tickets abfragen. Das
  Activity-Diagramm dazu sieht wie folgt aus:
