...
\newglossaryentry{Business-Logic}{
  name={Business Logic},
  description={Business Logic ist Software, welche die Logik einer Anwendung implementiert.}
}
...
\newglossaryentry{Open-Source}{
  name={Open-Source},
  description={Open-Source Software ist Software, deren Quell-Code öffentlich zugänglich und meistens auch bearbeitbar ist.}
}
