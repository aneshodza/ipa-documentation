...
\newglossaryentry{Ticket}{
  name={Ticket},
  description={Ein Ticket (im Kontext dieser PA) ist eine Aufgabe, welche im Redmine System eingetragen ist. Diese kann
...
\newglossaryentry{grün}{
  name={grün},
  description={Ein Commit oder eine Pull Request sind grün, wenn alle Tests auf der CI erfolgreich durchlaufen sind.}
}
